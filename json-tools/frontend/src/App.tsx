  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <ToolBar>
        ...
        <SwapBtn onSwap={() => { const t = left; setLeft(right); setRight(t); setResult(null) }} />
      </ToolBar>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ flex: 1, display: 'flex', gap: 1, background: 'var(--border)', overflow: 'hidden', minHeight: 0 }}>
          <EditorPane
            value={left}
            onChange={v => { setLeft(v); setResult(null) }}
          ...
          <EditorPane
            value={right}
            onChange={v => { setRight(v); setResult(null) }}
...
function EditorPane({ value, onChange, readOnly, placeholder, label, onDrop }: EditorPaneProps) {
